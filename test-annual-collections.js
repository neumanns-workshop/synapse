...
console.log("\n=== TEST RESULTS ===");
console.log("The year-agnostic approach successfully handles seasonal collections");
console.log("across different years, including ranges that wrap around the new year."); 