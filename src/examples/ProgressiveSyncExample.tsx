  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        This demonstrates the progressive sync system that breaks data
        synchronization into logical steps with progress indicators.
      </Text>
        ...
        <View style={styles.stepItem}>
          ...
          <View style={styles.stepText}>
            ...
            <Text style={styles.stepDesc}>
              Critical auth data, premium status
            </Text>
          </View>
        </View>
        <View style={styles.stepItem}>
