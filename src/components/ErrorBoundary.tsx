  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Card style={[styles.card, { backgroundColor: colors.errorContainer }]}>
        <Card.Content>
          <Text variant="headlineSmall" style={[styles.title, { color: colors.onErrorContainer }]}>
            Something went wrong
          </Text>
          <Text variant="bodyMedium" style={[styles.message, { color: colors.onErrorContainer }]}>
            An unexpected error occurred. Please try again.
          </Text>
          {__DEV__ && error && (
            <Text variant="bodySmall" style={[styles.errorDetails, { color: colors.onErrorContainer }]}>
              {error.message}
            </Text>
          )}
        </Card.Content>
