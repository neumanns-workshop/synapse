  ...
  const renderBackButton = () => (
    Platform.OS !== 'web' && onBack && (
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
        ...
        />
        <Text style={{ color: theme.colors.primary, fontSize: 16 }}>Back to Game</Text>
      </View>
    )
  );
  ...
  const renderTermsOfService = () => (
    <ScrollView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <View style={{ padding: 20, maxWidth: 800, alignSelf: 'center' }}>
        {renderBackButton()}
        <Text variant="headlineLarge" style={{ color: theme.colors.onBackground, marginBottom: 20 }}>
          Terms of Service
        </Text>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            <Text variant="headlineSmall" style={{ color: theme.colors.onSurface, marginBottom: 10 }}>
              1. Acceptance of Terms
            </Text>
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              By accessing or using Synapse ("the Service"), a word navigation puzzle game operated by Neumann's Workshop, LLC, 
              doing business as Galaxy Brain Entertainment ("Company", "we", "us", or "our"), you agree to be bound by these 
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24, marginBottom: 10 }}>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24, marginBottom: 10 }}>
              ...
              • Premium purchase provides permanent access to enhanced features{'\n'}
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              ...
              • Manage privacy preferences including analytics and leaderboards{'\n'}
              ...
              • Contact support for assistance with account management
            </Text>
          </Card.Content>
        </Card>
        ...
        <Text style={{ color: theme.colors.onSurfaceVariant, textAlign: 'center', marginTop: 20 }}>
          These Terms of Service are designed to protect both users and the service while maintaining a fair and enjoyable gaming experience.
        </Text>
      </View>
    </ScrollView>
  );
      ...
      <View style={{ padding: 20, maxWidth: 800, alignSelf: 'center' }}>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              Synapse ("we," "our," or "us") respects your privacy and is committed to protecting your personal information. 
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
              word navigation puzzle game.
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              ...
              • Game Progress: Game statistics, achievements, challenge completions{'\n'}
              • Payment Information: Processed securely through Stripe; we do not store credit card details{'\n'}
              • Usage Data: Game sessions, feature usage, and performance metrics (if opted in)
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              We use your information to provide and maintain the game service, sync your progress across devices, 
              process payments for premium features, and improve game performance and features.
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24, marginBottom: 12 }}>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              ...
              • Adjust email communication preferences{'\n'}
              • Access via Account Settings in the app{'\n\n'}
              
              <Text style={{ fontWeight: 'bold' }}>Data Rights:</Text>{'\n'}
              • Access your personal information{'\n'}
              • Correct inaccurate information{'\n'}
              • Request data portability{'\n'}
              • Contact us at synapse@neumannsworkshop.com{'\n\n'}
      ...
      <View style={{ padding: 20, maxWidth: 800, alignSelf: 'center' }}>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              Galaxy Brain Entertainment (operating under Neumann's Workshop, LLC) respects the intellectual property rights 
              of others and expects users to do the same. In accordance with the Digital Millennium Copyright Act of 1998 (DMCA), 
              we will respond promptly to valid notices of alleged copyright infringement.
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              ...
              in the Synapse game or website, please provide our designated Copyright Agent with the required information 
              including identification of the copyrighted work, your contact information, and a statement of good faith belief.
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              Synapse uses third-party AI models (such as Nomic AI, MiniLM, Qwen embeddings) for semantic word relationships. 
              These models are licensed under open source terms and developed by third parties. DMCA notices regarding AI model 
              outputs should be directed to the original model creators.
            </Text>
          </Card.Content>
        </Card>
      </View>
      ...
      <View style={{ padding: 20, maxWidth: 800, alignSelf: 'center' }}>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              Synapse™ is a word navigation puzzle game that challenges players to find paths between words using 
              semantic relationships. Navigate through a web of interconnected concepts to reach your target word.
            </Text>
          </Card.Content>
        </Card>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              Synapse™ is developed by Galaxy Brain Entertainment, operating under Neumann's Workshop, LLC.{'\n\n'}
      ...
      <View style={{ padding: 20, maxWidth: 800, alignSelf: 'center' }}>
        ...
        <Card style={{ marginBottom: 20, backgroundColor: theme.colors.surface }}>
          <Card.Content>
            ...
            <Text style={{ color: theme.colors.onSurface, lineHeight: 24 }}>
              For privacy-related requests that cannot be completed through the app:{'\n\n'}
              Email: synapse@neumannsworkshop.com{'\n'}
