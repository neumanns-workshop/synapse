...
export const ProgressiveSyncIndicator: React.FC<
  ProgressiveSyncIndicatorProps
> = ({ visible, onComplete }) => {
  ...
  const progressPercentage =
    (syncProgress.stepNumber / syncProgress.totalSteps) * 100;
    ...
    <View style={styles.overlay}>
      <View style={styles.container}>
        ...
        <View style={styles.stepContainer}>
          <Text style={styles.stepIcon}>{getStepIcon(syncProgress.step)}</Text>
          <View style={styles.stepTextContainer}>
            <Text style={styles.stepMessage}>{syncProgress.message}</Text>
        ...
        <View style={styles.stepsPreview}>
          {["profile", "challenges", "achievements", "history"].map(
            (step, index) => (
              <View
                key={step}
                style={[
                  styles.stepDot,
                  index < syncProgress.stepNumber
                    ? styles.stepDotCompleted
                    : {},
                  index === syncProgress.stepNumber - 1
