              ...
              {activeTab === "howtoplay" && (
                <>
                  ...
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    ...
                    Reach the{" "}
                    <Text
                      style={[styles.boldText, { color: customColors.endNode }]}
                    >
                      Target
                    </Text>{" "}
                    word from the{" "}
              ...
              {activeTab === "tips" && (
                <>
                  ...
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    ...
                    Click on the arrows or dots in your path to show or hide it
                    on screen.
                  </Paragraph>
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    <Text style={[styles.boldText, { color: colors.primary }]}>
                  ...
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    ...
                    where you went. Don't hesitate to recover known checkpoints
                    even if it costs a few moves.
                  </Paragraph>
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    <Text style={[styles.boldText, { color: colors.primary }]}>
                      Context Matters:
                    ...
                    words appear, not just categories and traditional dictionary
                    definitions.
                  </Paragraph>
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    <Text style={[styles.boldText, { color: colors.primary }]}>
                  ...
                  <Paragraph style={[paragraphStyle, styles.paragraph]}>
                    ...
                    Over time, you'll develop an intuitive sense of the semantic
                    topography - how different regions of meaning connect and
