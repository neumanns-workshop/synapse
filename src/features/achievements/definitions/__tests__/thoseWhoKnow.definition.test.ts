...
describe('Those Who Know Achievement', () => {
  ...
  it('should return true if a move was rarest AND global optimal (game won)', () => {
    ...
    mockGameStatus = 'won';
    expect(thoseWhoKnowAchievement.check(mockGameReport as GameReport, mockGameStatus)).toBe(true);
  });
  ...
  it('should return false if rarest choice was not optimal', () => {
    ...
    expect(thoseWhoKnowAchievement.check(mockGameReport as GameReport, mockGameStatus)).toBe(false);
  });
