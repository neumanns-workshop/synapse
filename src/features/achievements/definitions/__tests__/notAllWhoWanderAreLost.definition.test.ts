...
describe('Not All Who Wander Are Lost Achievement', () => {
  ...
  it('should return true if game won and all moves (excluding last) were not optimal/suggested', () => {
    ...
    mockGameStatus = 'won';
    expect(notAllWhoWanderAreLostAchievement.check(mockGameReport as GameReport, mockGameStatus)).toBe(true);
  });
  ...
  it('should return false if game won and an early move was optimal', () => {
    ...
    mockGameStatus = 'won';
    expect(notAllWhoWanderAreLostAchievement.check(mockGameReport as GameReport, mockGameStatus)).toBe(false);
  });
  ...
  it('should return false if gameReport is null or optimalChoices missing', () => {
    ...
    expect(notAllWhoWanderAreLostAchievement.check(mockGameReport as GameReport, 'won')).toBe(false);
  });
}); 