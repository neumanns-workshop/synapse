...
jest.mock('../../components/AvailableWordsDisplay', () => 'AvailableWordsDisplay');
jest.mock('../../components/GraphVisualization', () => 'GraphVisualization');
jest.mock('../../components/PathDisplayConfigurator', () => 'PathDisplayConfigurator');
jest.mock('../../components/PlayerPathDisplay', () => 'PlayerPathDisplay');
jest.mock('../../components/WordDefinitionDialog', () => 'WordDefinitionDialog');
