...
function filterWordList(words, graphDataPath) {
    return __awaiter(this, void 0, void 0, function () {
        var defaultPath, graphPath, graphRawData, graphData, validGraphWords, validWords, invalidWords, _i, words_1, word, normalizedWord, totalWords, percentValid;
        return __generator(this, function (_a) {
            defaultPath = path.join(__dirname, '..', 'data', 'graph.json');
            ...
            try {
                ...
                console.log("Valid words: ".concat(validWords.length, " (").concat(percentValid.toFixed(1), "%)"));
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var args, inputFile, outputPath, format, graphPath, i, arg, formatArg, inputText, words, result, formattedOutput, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    for (i = 0; i < args.length; i++) {
                        ...
                        if (arg === '--output' || arg === '-o') {
                            ...
                            if (formatArg === 'js' || formatArg === 'json') {
                                ...
                                throw new Error("Invalid format: ".concat(formatArg, ". Must be 'js' or 'json'"));
                            }
                        }
