...
function generateChallengeUrl(startWord, targetWord, theme = 'summer-vibes', baseUrl = 'https://synapse.game') {
...
async function main() {
  ...
  if (args.length < 2) {
    console.log('Usage: node generateStandaloneQR.js <startWord> <targetWord> [theme] [format] [size]');
    console.log('');
    console.log('Examples:');
    console.log('  node generateStandaloneQR.js music memory');
    console.log('  node generateStandaloneQR.js star infinite summer-vibes png 400');
