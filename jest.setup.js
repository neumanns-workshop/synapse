...
jest.mock('react-native-reanimated', () => {
  ...
  Reanimated.useAnimatedStyle = jest.fn(updater => typeof updater === 'function' ? updater() : {});
  ...
  Reanimated.FadeIn = { entering: jest.fn(() => ({})), duration: jest.fn().mockReturnThis(), delay: jest.fn().mockReturnThis(), withCallback: jest.fn().mockReturnThis() };
  Reanimated.FadeOut = { exiting: jest.fn(() => ({})), duration: jest.fn().mockReturnThis(), delay: jest.fn().mockReturnThis(), withCallback: jest.fn().mockReturnThis() };
  Reanimated.Layout = jest.fn(() => ({ duration: jest.fn().mockReturnThis(), delay: jest.fn().mockReturnThis(), withCallback: jest.fn().mockReturnThis() }));
